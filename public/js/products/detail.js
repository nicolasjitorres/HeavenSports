window.addEventListener('load', function () {
    ...
    let labelTalle = document.querySelector('.talle .product-lbl');
    ...
    inputStock.addEventListener('blur', () => {
        ...
        if (inputStock.value < 0) {
            return errorStock = validarError(boxStock, inputStock, labelStock, errorStock, "El stock debe ser mayor a 0.")
        }
    ...
    form.addEventListener('submit', (event) => {
        ...
        if (inputStock.value.length == 0) {
            ...
            errorStock = validarError(boxStock, inputStock, labelStock, errorStock, "El stock debe ser mayor a 0.")
            validado = false;
        }
